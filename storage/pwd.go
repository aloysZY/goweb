...
func main() {
	...
	loginPwd := "111"       // 用户登录时输入的密码
	// 密码验证
	err = bcrypt.CompareHashAndPassword([]byte("$2a$10$uSMnsz7ffcgdScYcb9d5Euv/uGkOxlVwtYDsRP9D84lf9.yPYFdDW"), []byte(loginPwd)) // 验证（对比）
	if err != nil {
